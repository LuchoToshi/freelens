...
hook that gets a reply is also product research.

## Seasonality: when Dutch client budgets actually move

| Window | What is happening on the client side | Who it is a hook for |
|---|---|---|
| jan–feb | Voorjaars- en zomercampagnes worden gebrieft; jaarbudgetten zijn net vers | Campagne-/brandfotografen, videografen |
| mrt–apr | Events- en festivalseizoen wordt ingekocht; nieuwe collecties gefotografeerd | Event-shooters, productfotografie |
| mei–jun | Q3/najaar-content wordt gepland vóór de zomerstop | Videografen, contentmakers |
| aug–sep | Najaarscampagnes lopen; "het jaar afmaken"-budget bestaat nog | Iedereen b2b |
| okt | Eindejaars- en feestdagencontent is nu of nooit | Food, retail, e-commerce |
| nov–dec | Restbudget moet op; januari-planningen beginnen | Kleine klussen, en het zaadje voor jan |
