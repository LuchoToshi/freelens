...
const NL_ASSUMPTIONS: Record<string, string> = {
  ...
  "Zvw is charged on your profit after the entrepreneur deductions and the MKB-winstvrijstelling. That is what the Zorgverzekeringswet (article 43) and the Wet inkomstenbelasting 2001 (article 3.2) prescribe.":
    "De Zvw wordt berekend over je winst na de ondernemersaftrek en de MKB-winstvrijstelling. Zo schrijven de Zorgverzekeringswet (artikel 43) en de Wet inkomstenbelasting 2001 (artikel 3.2) het voor.",
  ...
  "The Zvw maximum contribution base is applied to business profit alone. Article 43 of the Zorgverzekeringswet shares that maximum across a job and a business, so with employment income alongside the business this estimate can overstate Zvw at high combined income.":
    "Het maximum bijdrage-inkomen voor de Zvw wordt alleen op je winst toegepast. Artikel 43 van de Zorgverzekeringswet deelt dat maximum tussen een baan en een onderneming, dus heb je daarnaast loon, dan kan deze schatting de Zvw bij een hoog gezamenlijk inkomen te hoog inschatten.",
