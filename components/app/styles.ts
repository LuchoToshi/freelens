...
export const inputClass =
  "rounded-lg border border-[var(--fl-line-control)] bg-white transition focus-visible:border-[var(--fl-focus-ring)] focus-visible:ring-2 focus-visible:ring-[var(--fl-focus-ring)]/25 focus-visible:outline-none";

export const pillButtonClass =
  "inline-flex min-h-11 w-fit items-center gap-1.5 rounded-lg border border-[var(--fl-line-control)] bg-white px-3 py-1.5 text-sm font-medium text-[var(--fl-ink)] transition hover:border-[var(--fl-ink)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--fl-focus-ring)]";
...
export const secondaryButtonClass =
  "inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-[var(--fl-line-control)] bg-white px-6 text-base font-medium text-[var(--fl-ink)] transition hover:border-[var(--fl-ink)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--fl-ink)]";
